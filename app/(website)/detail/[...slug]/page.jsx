...
export default async function PostDetail(route) {
  ...
  return (
    <div className="container max-w-screen-lg mx-auto">
      ...
      <div className="relative w-full h-[500px] object-contain m-10 rounded-md overflow-hidden">
        <Image fill src={post.mainImage?.asset?.url} />
      </div>
      <div className="flex justify-center">
        <p className="max-w-screen-md mx-16 p-10">{post.description}</p>
      </div>
      <div className="flex justify-center">
        <div className="max-w-screen-md mx-16 p-10">
